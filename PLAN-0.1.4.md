...
（批 7 打包/上传结果）
- commit `4515e80`（61 文件 +2797/-302，纯源码）push origin main 首次即成（代理 7890）；tag v0.1.4 同步推送；ls-remote 双确认
- 行数扫描（版本收尾）：SettingsPanel 701（新功能已全拆 settings/ 子组件仍越线，0.1.5 拆分区主体）· sqlite_store 546 · indexer 538（均越线待拆，上报架构债）；新文件全部 <320 行合规
